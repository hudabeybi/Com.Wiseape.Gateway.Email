...
namespace Com.Wiseape.Framework
{
    public class Factory
    {
        ...
        public static object Create(string key, ClassType classType)
        {
            ...
            Configurations configurations = Com.Wiseape.Utility.Serializer.XML.Deserialize<Configurations>(xml);
            ...
            if (fc != null)
            {
                ...
                object obj = Com.Wiseape.Utility.Assembly.LoadObject(filename, fc.AssemblyInfo.ClassName);
                return obj;
            }
            return null;
        }
        ...
        public static T Create<T>(string key, ClassType classType)
        {
            ...
            if (fc != null)
            {
                ...
                obj = (T)Com.Wiseape.Utility.Assembly.LoadObject(filename, fc.AssemblyInfo.ClassName);
                return obj;
            }
        ...
        static string GetFileName()
        {
            ...
            string folderName = System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath;
            string fileName = folderName + "Resources\\Config\\Com.Wiseape.Factory.Config";
